...
const attacks = [
  {
    title: "Phishing",
    desc: "Tricking users into giving up sensitive info.",
    img: "imgs/phishing.png"
  },
  {
    title: "Malware",
    desc: "Malicious software that damages or disables systems.",
    img: "imgs/malware.png"
  },
  {
    title: "Ransomware",
    desc: "Encrypts files and demands payment for decryption.",
    img: "imgs/ransomware.png"
  },
  {
    title: "DDoS Attack",
    desc: "Overwhelms a system with traffic to disrupt service.",
    img: "imgs/ddos.jpeg"
  },
  {
    title: "Man-in-the-Middle",
    desc: "Intercepts communication between two parties.",
    img: "imgs/mittm.png"
  },
  {
    title: "SQL Injection",
    desc: "Injects malicious SQL queries into databases.",
    img: "https://your-image-url.com/sqlinjection.png"
  },
  {
    title: "Zero-Day Exploit",
    desc: "Targets vulnerabilities before they are patched.",
    img: "https://your-image-url.com/zeroday.png"
  },
  {
    title: "Password Attack",
    desc: "Attempts to crack or steal passwords.",
    img: "https://your-image-url.com/passwordattack.png"
  },
  {
    title: "Drive-By Download",
    desc: "Downloads malware without user consent.",
    img: "https://your-image-url.com/driveby.png"
  },
  {
    title: "Cross-Site Scripting (XSS)",
    desc: "Injects malicious scripts into trusted websites.",
    img: "https://your-image-url.com/xss.png"
  },
  {
    title: "Social Engineering",
    desc: "Manipulates people into revealing confidential info.",
    img: "imgs/socialengineering.svg"
  },
  {
    title: "Spyware",
    desc: "Secretly monitors user activity.",
    img: "https://your-image-url.com/spyware.png"
  },
  {
    title: "Adware",
    desc: "Displays unwanted advertisements.",
    img: "https://your-image-url.com/adware.png"
  },
  {
    title: "Trojan Horse",
    desc: "Disguises as legitimate software.",
    img: "https://your-image-url.com/trojan.png"
  },
  {
    title: "Rootkit",
    desc: "Hides malicious processes from detection.",
    img: "https://your-image-url.com/rootkit.png"
  },
  {
    title: "Session Hijacking",
    desc: "Takes over a user session.",
    img: "https://your-image-url.com/sessionhijack.png"
  }
];
          ...
          <Grid item xs={12} sm={6} md={3} key={idx}>
            <Fade in timeout={500 + idx * 30}>
              <Card sx={{ height: "100%", bgcolor: "background.paper", borderRadius: 3 }}>
                <Box sx={{ height: 100, mb: 2, bgcolor: "#222", borderRadius: 2, display: "flex", alignItems: "center", justifyContent: "center" }}>
                  {/* Image placeholder */}
                  {item.img ? (
                    <img src={item.img} alt={item.title} style={{ maxWidth: "80%", maxHeight: "80%" }} />
                  ) : (
            ...
            <Fade in timeout={500 + idx * 30}>
              <Card sx={{ height: "100%", bgcolor: "background.paper", borderRadius: 3 }}>
                <Box sx={{ height: 120, display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <img src={item.img} alt={`Tip ${idx + 1}`} style={{ maxWidth: "90%", maxHeight: "90%" }} />
                </Box>
              </Card>
            </Fade>
          </Grid>
